...
const firstName: string = `Hussnain Javed`
...
const favorite_number: number = 786
...
const names: string[] = [`Ali`, `Hassan`, `Junaid`, `Baber`]
...
const _names: string[] = [`Ali`, `Hassan`, `Junaid`, `Baber`]
...
const thingsOwned: string[] = [`I would own Motorcycle`, `I would own Apple Iphone`]
