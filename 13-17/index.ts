...
const broadCastInvitation = (list: string[]) => {
...
const guestList: string[] = [`Ali`, `Hassan`, `Baber`, `Sajid`]
...
const newGuest: string[] = [`Hadi`, `Hammad`, `Hashmat`]

// its spread operator implementation , used to add two arrays 
const guestForBiggerTable: string[] = [...newGuestList, ...newGuest]
